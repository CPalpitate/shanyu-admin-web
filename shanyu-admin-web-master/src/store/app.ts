...
import { DEFAULT_THEME_OVERRIDES } from '@/theme'
...
export const useAppStore = defineStore('app', {
    state: (): AppState => ({
        ...
        theme: 'light',
        themeOverrides: structuredClone(DEFAULT_THEME_OVERRIDES),
    ...
    actions: {
        ...
        resetSettings() {
            ...
            this.themeOverrides = structuredClone(DEFAULT_THEME_OVERRIDES)
        },
    },
